...
class oreXpressParamCalculator:
    ...
    def HCPINDEX2(self):
        ...
        R2120 = getRvalue(spectrum, wvt,2120)
        R2140 = getRvalue(spectrum, wvt,2140)
        R2230 = getRvalue(spectrum, wvt,2230)
        R2250 = getRvalue(spectrum, wvt,2250)
        R2430 = getRvalue(spectrum, wvt,2430)
        R2460 = getRvalue(spectrum, wvt,2460)
        R2530 = getRvalue(spectrum, wvt,2530)
        R1810 = getRvalue(spectrum, wvt,1810)
        R1690 = getRvalue(spectrum, wvt,1690)
    ...
    def LCPINDEX2(self):
        ...
        # extract data from image spectrum
        R1690 = getRvalue(spectrum, wvt, 1690)
        R1750 = getRvalue(spectrum, wvt, 1750)
        R1810 = getRvalue(spectrum, wvt, 1810)
        R1870 = getRvalue(spectrum, wvt, 1870)
        R1560 = getRvalue(spectrum, wvt, 1560)
        R2450 = getRvalue(spectrum, wvt, 2450)
    ...
    def OLINDEX3(self):
        ...
        wvt=self.wvt
        # extract data from image spectrum
        R1210 = getRvalue(spectrum, wvt,1210)
        R1250 = getRvalue(spectrum, wvt,1250)
        R1263 = getRvalue(spectrum, wvt,1263)
        R1276 = getRvalue(spectrum, wvt,1276)
        R1330 = getRvalue(spectrum, wvt,1330)
        R1750 = getRvalue(spectrum, wvt,1750)
        R1862 = getRvalue(spectrum, wvt,1862)
    ...
    def BD530_2(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue = getRvalueDepth(spectrum,wvt,440,530,614)
        return paramValue
    def BD920_2(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue = getRvalueDepth(spectrum,wvt,807,920,984)
        return paramValue
    def BD2210_2(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue = getRvalueDepth(spectrum,wvt,2165,2210,2290) #(kaolinite group)
        return paramValue
    def BD2190(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue = getRvalueDepth(spectrum,wvt,2120,2185,2250,mw=3,hw=3) #(Beidellite, Allophane)
        return paramValue
    def BD2250(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue = getRvalueDepth(spectrum,wvt,2120, 2245, 2340,mw=7,hw=3) 
        return paramValue
    def BD2165(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue = getRvalueDepth(spectrum,wvt,2120,2165,2230,mw=3,hw=3) #(kaolinite group)
        return paramValue
    def BD2355(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue = getRvalueDepth(spectrum,wvt,2300, 2355, 2450) #(fe/mg phyllo group)
        return paramValue
    def BD2290(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue = getRvalueDepth(spectrum,wvt,2250, 2290, 2350) #(fe/mg phyllo group)
        return paramValue
    def D2200(self):
        spectrum = self.spectrum
        wvt = self.wvt
        # extract individual channels
        R1815 = getRvalue(spectrum, wvt,1815, kwidth=7)
        R2165 = getRvalue(spectrum, wvt,2165)
        R2210 = getRvalue(spectrum, wvt,2210, kwidth=7)
        R2230 = getRvalue(spectrum, wvt,2230, kwidth=7)
        R2430 = getRvalue(spectrum, wvt,2430, kwidth=7)
    ...
    def D2300(self):
        ...
        wvt = self.wvt
        # extract individual channels
        R1815 = getRvalue(spectrum,wvt,1815)
        R2120 = getRvalue(spectrum,wvt,2120)
        R2170 = getRvalue(spectrum,wvt,2170)
        R2210 = getRvalue(spectrum,wvt,2210)
        R2290 = getRvalue(spectrum,wvt,2290,kwidth=3)
        R2320 = getRvalue(spectrum,wvt,2320,kwidth=3)
        R2330 = getRvalue(spectrum,wvt,2330,kwidth=3)
        R2530 = getRvalue(spectrum,wvt,2530)
    ...
    def BD1900r2(self):
        ...
        R1908 = getRvalue(spectrum,wvt,1908, kwidth = 1) 
        R1914 = getRvalue(spectrum,wvt,1914, kwidth = 1) 
        R1921 = getRvalue(spectrum,wvt,1921, kwidth = 1) 
        R1928 = getRvalue(spectrum,wvt,1928, kwidth = 1) 
        R1934 = getRvalue(spectrum,wvt,1934, kwidth = 1) 
        R1941 = getRvalue(spectrum,wvt,1941, kwidth = 1) 
        R1862 = getRvalue(spectrum,wvt,1862, kwidth = 1) 
        R1869 = getRvalue(spectrum,wvt,1869, kwidth = 1) 
        R1875 = getRvalue(spectrum,wvt,1875, kwidth = 1) 
        R2112 = getRvalue(spectrum,wvt,2112, kwidth = 1) 
        R2120 = getRvalue(spectrum,wvt,2120, kwidth = 1) 
        R2126 = getRvalue(spectrum,wvt,2126, kwidth = 1) 
        
        R1815 = getRvalue(spectrum, wvt, 1815);
        R2132 = getRvalue(spectrum, wvt, 2132); 
    ...
    def MIN2295_2480(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue1 = getRvalueDepth(spectrum, wvt,2165,2295,2364)
        paramValue2 = getRvalueDepth(spectrum,wvt,2364,2480,2570)
    ...
    def MIN2250(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue1 = getRvalueDepth(spectrum, wvt,2165, 2210, 2350)
        paramValue2 = getRvalueDepth(spectrum,wvt,2165, 2265, 2350)
        paramValue3 = [paramValue1,paramValue2]
        paramValue = np.min(paramValue3)
        if paramValue is -np.inf:
            paramValue = np.nan
    ...
    def MIN2345_2537(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue1 = getRvalueDepth(spectrum, wvt,2250, 2345, 2430)
        paramValue2 = getRvalueDepth(spectrum,wvt,2430, 2537, 2602)
        paramValue3 = [paramValue1,paramValue2]
        paramValue = np.min(paramValue3)
        if paramValue is -np.inf:
            paramValue = np.nan
    ...
    def BDCARB(self):
        ...
        R2230 = getRvalue(spectrum, wvt, 2230)
        R2320 = getRvalue(spectrum, wvt, 2320)
        R2330 = getRvalue(spectrum, wvt, 2330)
        R2390 = getRvalue(spectrum, wvt, 2390)
        R2520 = getRvalue(spectrum, wvt, 2520)
        R2530 = getRvalue(spectrum, wvt, 2530)
        R2600 = getRvalue(spectrum, wvt, 2600)
    ...
    def SINDEX2(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue = getRvalueDepthInvert(spectrum,wvt,2120, 2290, 2400,mw=7,hw=3)
        return paramValue
    def BD2100_2(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue = getRvalueDepth(spectrum,wvt,1930, 2132, 2250,lw=3,hw=3)
        return paramValue
    def BD1900_2(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue = getRvalueDepth(spectrum,wvt,1850, 1930, 2067)
        return paramValue
    def ISLOPE(self):
        spectrum = self.spectrum
        wvt = self.wvt
    ...
    def BD1400(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue = getRvalueDepth(spectrum,wvt,1330, 1395, 1467,mw=3)
        return paramValue
    def IRR2(self):
        spectrum = self.spectrum
        wvt = self.wvt
        paramValue = getRvalueRatio(spectrum,wvt,2530,2210)
        return paramValue
    # -------------------------------------------------------------------------
    # Browse Products
    # -------------------------------------------------------------------------
