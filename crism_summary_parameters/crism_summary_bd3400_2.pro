...
; CEV modified May 2012 to band center at 3420 to 'split the difference' between
; Ca- and Mg-Carbonate absorption position.
;------------------------------------------------------------------------
function crism_summary_bd3400_2,cube,wvt,hyper=hyper,ignore_val=ignore_val
    ...
    if keyword_set(hyper) then begin
       ...
       ; hyper spectral movitivation:
        ...
        img = crism_sumutil_band_depth( cube, wvt, 3250, 3420, 3630, hyper=hyper, ignore_val=ignore_val, low_width=10, mid_width = 15, hi_width=10)
