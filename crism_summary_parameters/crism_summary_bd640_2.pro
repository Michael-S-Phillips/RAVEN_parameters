...
;------------------------------------------------------------------------
function crism_summary_bd640_2,cube,wvt,hyper=hyper, ignore_val=ignore_val

    return, crism_sumutil_band_depth ( cube, wvt, 600, 624, 760, $ ;709 ->760  and 648 -> 624 with kernel width of 3 to avoid max wv gap tolerance (CEV)
