;------------------------------------------------------------------------
;
;  This function is used to compute generic *inverted band depth
;
...
;
;  Howard Taylor (modified from crism_sumutil_band_depth by Christina Viviano, May 2012)
;  JHU/APL
;  06/03/2011
;
;------------------------------------------------------------------------
function crism_sumutil_band_depth_invert,cube,wvt,low,mid,hi,hyper=hyper, $
